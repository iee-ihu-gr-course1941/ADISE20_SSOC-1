...
/* file name config.php can be modifire, please follow last version */
...
?>
		...
		(Follow the <a href="http://sso.macroweb.gr/docs/">instructions</a> to learn how to use the SSO Client.)<br />
<?php
	}
	else
	{
...
<div id="main">
	...
	<div id="page2" class="box" style="display: none;">
		...
		<div class="boxmain">
			...
			<ul>
				<li><a href="http://www.php.net/" target="_blank">PHP 8.0.x or later</a> (preferably the latest)</li>
				<li><a href="http://sso.macroweb.gr/documentation/ssoserver/" target="_blank">A valid Single Sign-On (SSO) Server API key and secret</a></li>
			</ul>
		</div>
		...
		<div class="boxmain">
			...
			<div class="formfields">
				...
				<div class="formitem">
					...
					<div class="formitemdesc">Two keys and two IVs are used to encrypt data twice with the same cipher as per <a href="http://apps.macroweb.gr/news/#" target="_blank">this post</a>.</div>
				</div>
				<div class="formitem">
