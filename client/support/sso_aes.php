<?php
/** 
 * SSO Client - AES packetization class.  Requires phpseclib AES.php + Rijndael.php
 * sso_aes .php / support/client/ . Macroweb
 ...
 *
 * @package sso_aes.php /support/client/ . Macroweb
 * @subpackage support / sso_aes.php /support/client/ 
 * @since 00.00.02
 * @param sso_aes param sso_aes.php /support/client/ 
 */
