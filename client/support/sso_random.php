<?php
/** 
 * SSO Client - Cryptographically Secure Pseudo-Random String Generator (CSPRSG) and CSPRNG.
 * sso_random .php / support/client/ . Macroweb
 ...
 *
 * @package sso_random.php /support/client/ . Macroweb
 * @subpackage support / sso_random.php /support/client/ 
 * @since 00.00.02
 * @param sso_random param sso_random.php /support/client/ 
 */
