<?php
/** 
 * SSO Client - Admin Pack server-side page manipulation functions.
 * page_basics .php / support/client/ . Macroweb
 ...
 *
 * @package page_basics.php /support/client/ . Macroweb
 * @subpackage support / page_basics.php /support/client/ 
 * @since 00.00.02
 * @param page_basics param page_basics.php /support/client/ 
 */
	...
	// Code swiped from Macroweb browser cookie support functions.
