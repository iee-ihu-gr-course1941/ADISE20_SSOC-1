<?php
/** 
 * SSO Client - Basic PHP String helper/processing functions.
 * str_basics .php / support/client/ . Macroweb
 ...
 *
 * @package str_basics.php /support/client/ . Macroweb
 * @subpackage support / str_basics.php /support/client/ 
 * @since 00.00.02
 * @param str_basics param str_basics.php /support/client/ 
 */
	...
	class Str
	{
		...
		// Constant-time string comparison.  Ported from Macroweb C++ code.
