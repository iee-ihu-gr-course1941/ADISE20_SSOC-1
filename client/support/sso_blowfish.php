<?php
/** 
 * SSO Client - Blowfish packetization and hashing class.  Requires phpseclib Blowfish.php
 * sso_blowfish .php / support/client/ . Macroweb
 ...
 *
 * @package sso_blowfish.php /support/client/ . Macroweb
 * @subpackage support / sso_blowfish.php /support/client/ 
 * @since 00.00.02
 * @param sso_blowfish param sso_blowfish.php /support/client/ 
 */
