<?php
/** 
 * SSO Client - PHP IP Address functions.  Modified for SSO Client integration.
 * sso_ipaddr .php / support/client/ . Macroweb
 ...
 *
 * @package sso_ipaddr.php /support/client/ . Macroweb
 * @subpackage support / sso_ipaddr.php /support/client/ 
 * @since 00.00.02
 * @param sso_ipaddr param sso_ipaddr.php /support/client/ 
 */
